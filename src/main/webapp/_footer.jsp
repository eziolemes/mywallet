<footer class="sticky-footer">
    <div class="container">
        <div class="text-center">
            <small> © 2020
                <a href="http://www.mywallet.com.br" target="_blank" >My wallet</a>
            </small>
        </div>
    </div>
</footer>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Clique em "Sair" para encerrar o sistema.</div>
    ...
    <script src="public/assets/js/sb-admin-datatables.min.js"></script>
